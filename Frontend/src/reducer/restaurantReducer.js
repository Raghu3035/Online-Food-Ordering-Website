...
export const restaurantReducer=(state=initialState,action) => {
    switch(action.type)
    {
        ...
        case SEARCH_RESTAURANTS:
            return {
                ...state,
                filteredRestaurants: action.payload.filteredRestaurants || state.restaurants,
                filteredFoodItems: action.payload.filteredFoodItems || [],
                isFoodSearchActive: action.payload.isFoodSearchActive || false,
